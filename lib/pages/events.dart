...
class _EventsPageState extends State<EventsPage> {
  ...
  Future<List<SwipeItem>> populateSwipeItems(ApplicationState appState) async {
      ...
      builder: (context, appState, _) {
        return FutureBuilder(
            ...
            builder: (BuildContext context,
                AsyncSnapshot<List<SwipeItem>> snapshot) {
              switch (snapshot.connectionState) {
                ...
                default:
                  ...
                  this._matchEngine = MatchEngine(swipeItems: snapshot.data);
